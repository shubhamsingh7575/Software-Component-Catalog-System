...
public class CatalogueComponentController {
    ...
    @GetMapping("/search")
    public List<ComponentResponse> searchComponents(@PathVariable Long catalogueId, @RequestParam String keywords) {
        return componentService.searchComponents(catalogueId, keywords);
    }
