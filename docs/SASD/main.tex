...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{context_diagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{dfd_level_1.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{dfd_level_2_auth.jpeg}
    \caption{Level 2 - Authentication Module}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{dfd_level_2_component.jpeg}
    \caption{Level 2 - Component Management Module}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{dfd_level_2_file_handling.jpeg}
    \caption{Level 2 - File Handling Module}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{dfd_level_2_search.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{UML_diagrams/use_case_diagram.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{UML_diagrams/class_diagram.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{UML_diagrams/sequence_diagram.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{UML_diagrams/state_chart_diagram.jpeg}
