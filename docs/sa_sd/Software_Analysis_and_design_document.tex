...
The system is deployed as a client-server application.
\begin{itemize}[leftmargin=1.2cm]
    \item Users access the system through a desktop client.
    \item The frontend communicates with backend services over HTTP.
