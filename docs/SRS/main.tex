...
\begin{itemize}
    \item \textbf{Frontend:}
    \begin{itemize}
        \item React.js for building an interactive and dynamic user interface
        \item JavaSwing for structure and styling
    \end{itemize}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{use_case_diagram.jpeg}    
\end{figure}
